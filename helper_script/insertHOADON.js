...
connection.connect((err) => {
  ...
  const insertData = () => {
    ...
    const query =
      "INSERT INTO HOADON (MaTTDC, MaXe, MaNV, MaKH, MaKM, NgayKy, TongGiaTri, PTTT) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    const values = [
      fakeMaTTDC,
      fakeMaXe,
      fakeMaNV,
